...
@Component({
  ...
  standalone: true,
  imports: [MatDialogModule, MatButtonModule,MceEditorComponent,MatTabsModule,MatFormFieldModule, MatInputModule, MatTableModule, MatSortModule, MatPaginatorModule,MatSelectModule],
